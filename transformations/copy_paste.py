...
"""
Ghiasi et al. 2020 - "Simple Copy-Paste is a Strong Data Augmentation Method for Instance Segmentation"
"""
...
def copy_paste(
        ...
        blending: bool = True,
        resize_interpolation: v2.InterpolationMode = v2.InterpolationMode.BILINEAR,
    ...
    if size1 != size2:
        ...
        paste_masks = F.resize(paste_masks, size1, interpolation=v2.InterpolationMode.NEAREST)
...
class SimpleCopyPaste(torch.nn.Module):
    ...
    def __init__(self, blending=True, resize_interpolation=v2.InterpolationMode.BILINEAR):
        super().__init__()
    ...
    def forward(
            ...
            for image, target, paste_image, paste_target in zip(images, targets, images_rolled, targets_rolled):
                output_image, output_data = copy_paste(
                    image,
                    target,
                    paste_image,
                    paste_target,
